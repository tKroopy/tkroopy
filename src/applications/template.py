...
class Template(page.Page):
    ...
    """
    # Change to True to make visible in the compiled version.
    production = False
    ...
    def __init__(self, root, name, *args, **kwargs):
        ...
        # Title of the application in the main menu
        self.title = 'Application Title'
        
        # Define tables for DAL
        self.models()
...
if __name__ == '__main__':
    root = Tkinter.Tk()
    main = getattr(os.path.basename, os.path.splittext('__file__')[0].title())
